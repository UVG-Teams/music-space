...
class Invoice(models.Model):
    ...
    customerid = models.ForeignKey("customers.Customer", on_delete=models.SET_NULL, blank=True, null=True, db_column="customerid") #customerid = models.IntegerField(blank=False, null=False)
